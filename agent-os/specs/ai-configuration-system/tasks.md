...
- [ ] 5.1.0 Complete core type system for AI configuration
  - [ ] 5.1.1 Write 2-8 focused tests for type definitions and validation
  ...
  - [ ] 5.1.2 Define AIConfiguration interface in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/compiler/types.ts`
  ...
  - [ ] 5.1.3 Extend BookDefinition interface in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/compiler/YamlInputParser.ts`
    - Add optional `aiConfig?: AIConfiguration` field (spec lines 314-320)
    - Document configuration hierarchy in JSDoc
  - [ ] 5.1.4 Extend ChapterDefinition interface in same file
    - Add optional `aiConfig?: AIConfiguration` field (spec lines 325-329)
    - Document chapter-level override behavior
  - [ ] 5.1.5 Extend AITextContent and AIQuizContent interfaces
  ...
  - [ ] 5.1.6 Extend HandlerContext interface in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/handlers/HandlerContext.ts`
...
- [ ] 5.2.0 Complete reading level preset system
  - [ ] 5.2.1 Write 2-8 focused tests for reading level presets
  ...
  - [ ] 5.2.2 Define ReadingLevelPreset interface in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/ai/AIPromptBuilder.ts`
    - Create interface with sentenceLength, vocabulary, style, examples fields (spec lines 400-406)
  - [ ] 5.2.3 Create preset configuration for elementary level
  ...
  - [ ] 5.2.4 Create preset configuration for grade-6 level (DEFAULT)
  ...
  - [ ] 5.2.5 Create preset configurations for remaining 6 levels
  ...
  - [ ] 5.2.6 Create tone presets record
  ...
  - [ ] 5.2.7 Document reading level selection guide
  ...
  - [ ] 5.2.8 Ensure reading level preset tests pass
...
- [ ] 5.3.0 Complete AIPromptBuilder service implementation
  - [ ] 5.3.1 Write 2-8 focused tests for AIPromptBuilder
  ...
  - [ ] 5.3.2 Create AIPromptBuilder class in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/ai/AIPromptBuilder.ts`
    - Make class stateless with static methods only (spec line 43)
    - Import AIConfiguration, ReadingLevel, Tone from types
  - [ ] 5.3.3 Implement FORMATTING_RULES constant
  ...
  - [ ] 5.3.7 Implement buildCompletePrompt() method
  ...
  - [ ] 5.3.8 Implement resolveConfig() method
  ...
  - [ ] 5.3.9 Ensure AIPromptBuilder tests pass
...
- [ ] 5.4.0 Complete AI handler integration with AIPromptBuilder
  - [ ] 5.4.1 Write 2-8 focused tests for handler integration
  ...
  - [ ] 5.4.2 Update AITextHandler in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/handlers/core/AITextHandler.ts`
  ...
  - [ ] 5.4.3 Add aiConfig validation to AITextHandler.validate()
  ...
  - [ ] 5.4.4 Update QuizHandler in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/handlers/ai/QuizHandler.ts`
  ...
  - [ ] 5.4.5 Add aiConfig validation to QuizHandler.validate()
    - Same validation as AITextHandler (spec lines 760-772)
    - Reuse validation logic or extract to shared utility
  - [ ] 5.4.6 Update QuizGenerator in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/ai/QuizGenerator.ts`
  ...
  - [ ] 5.4.7 Ensure handler integration tests pass
...
**Note:** This task group implements the **Interactive Book entry point** (YAML/JSON) for AI configuration. The **Smart Import entry point** (API) will be documented as foundation for Phase 6 in Task Group 5.8.

- [ ] 5.5.0 Complete Interactive Book AI configuration integration
  - [ ] 5.5.1 Write 2-8 focused tests for YAML parsing
  ...
  - [ ] 5.5.2 Update YamlInputParser in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/compiler/YamlInputParser.ts`
  ...
  - [ ] 5.5.3 Add aiConfig validation to validateBookDefinition()
  ...
  - [ ] 5.5.4 Add aiConfig validation to validateContentItem()
    - Same validation for item-level aiConfig
    - Maintain existing validation logic (spec line 134)
  - [ ] 5.5.5 Update H5pCompiler in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/src/compiler/H5pCompiler.ts`
  ...
  - [ ] 5.5.6 Update createContext() method in H5pCompiler
  ...
  - [ ] 5.5.7 Ensure YAML parser integration tests pass
...
**Acceptance Criteria:**
- The 2-8 tests written in 5.5.1 pass
...
- [ ] 5.6.0 Verify backward compatibility and create migration path
  - [ ] 5.6.1 Write 2-8 focused tests for backward compatibility
    - Test existing YAML file without aiConfig compiles successfully
    - Test default values applied (grade-6, educational, plain-html)
    - Test old prompts with embedded formatting instructions still work
    - Test gradual adoption: book with some items having aiConfig, others not
    - Test migration from old style to new style prompts
    - Skip exhaustive migration scenario testing
  - [ ] 5.6.2 Test existing YAML files from test suite
    - Run existing integration tests to verify no breaking changes
    - Verify all existing YAML test fixtures compile successfully
    - Check that AI output quality is maintained or improved
  - [ ] 5.6.3 Verify default value behavior
    - Confirm grade-6 reading level used when no aiConfig
    - Confirm educational tone used when no aiConfig
    - Confirm plain-html output style used when no aiConfig
    - Test across AITextHandler and QuizHandler
  - [ ] 5.6.4 Test prompts with embedded instructions
    - Create test cases with old-style prompts containing formatting rules
    - Verify these still work (formatting rules now duplicated, but harmless)
    - Verify output quality is same or better
  - [ ] 5.6.5 Document migration path in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/docs/migration-guide-phase5.md`
    - Explain optional nature of aiConfig (spec lines 1228-1240)
    - Show before/after examples for cleaning up prompts (spec lines 1283-1298)
    - Provide step-by-step migration instructions (spec lines 1242-1280)
    - Include troubleshooting section
  - [ ] 5.6.6 Create example YAML files showing migration
    - Old style: prompts with embedded formatting instructions
    - New style: clean prompts with aiConfig
    - Hybrid: gradual adoption with mixed approach
  - [ ] 5.6.7 Ensure backward compatibility tests pass
    - Run ONLY the 2-8 tests written in 5.6.1
    - Verify no breaking changes to existing functionality
    - Verify default values work correctly
    - Do NOT run entire test suite at this stage

**Acceptance Criteria:**
- The 2-8 tests written in 5.6.1 pass
- All existing YAML test fixtures compile successfully without modification
- Default values (grade-6, educational) applied when aiConfig absent
- Old-style prompts with embedded instructions still work
- Migration documentation provides clear path for users
- Example YAML files demonstrate best practices
...
- [ ] 5.7.0 Complete comprehensive documentation and Smart Import API foundation
  - [ ] 5.7.1 Write 2-8 focused tests for documentation examples
  ...
  - [ ] 5.7.2 Update YAML format reference in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/docs/yaml-format.md`
  ...
  - [ ] 5.7.3 Update API Integration Guide in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/docs/api-integration.md`
  ...
  - [ ] 5.7.4 Create Teacher's Guide in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/docs/teacher-guide-ai-config.md`
  ...
  - [ ] 5.7.5 Create Prompt Engineering Reference in `/Users/benjaminwaller/Projects/H5P-LMS/h5p-cli-creator/docs/prompt-engineering.md`
  ...
  - [ ] 5.7.7 Generate JSON Schema for frontend
  ...
  - [ ] 5.7.8 Document Smart Import API pattern (Phase 6 foundation)
  ...
  - [ ] 5.7.9 Create Smart Import API request examples
  ...
  - [ ] 5.7.10 Ensure documentation tests pass
...
- Teacher's Guide written in accessible, non-technical language
- Prompt Engineering Reference explains system prompt construction
- JSON Schema files generated for frontend consumption
- Smart Import API documentation complete (foundation for Phase 6 implementation)
- Smart Import examples demonstrate universal aiConfig usage across content types
- Clear distinction between Interactive Book entry point (Phase 5) and Smart Import entry point (Phase 6)
- All documentation examples are tested and valid
- Main README updated with Phase 5 features
...
1. **Task Group 5.1**: Core Types and Interfaces (Days 1-2)
   - Universal AIConfiguration types (NOT tied to BookDefinition)

2. **Task Group 5.2**: Reading Level Presets (Days 2-3)
   - 8 reading levels, 4 tone options

3. **Task Group 5.3**: AIPromptBuilder Service (Days 3-5)
   - Stateless, universal prompt builder for ALL content types

4. **Task Group 5.4**: Handler Integration (Days 6-8)
   - AITextHandler and QuizHandler use AIPromptBuilder

5. **Task Group 5.5**: Interactive Book Entry Point (Days 9-11)
   - YAML/JSON parsing for BookDefinition.aiConfig

6. **Task Group 5.6**: Backward Compatibility and Migration (Days 12-13)
   - Ensure existing YAML files work unchanged

7. **Task Group 5.7**: Documentation and Smart Import Foundation (Days 14-16)
...
├── migration-guide-phase5.md         # Migration instructions (NEW)
